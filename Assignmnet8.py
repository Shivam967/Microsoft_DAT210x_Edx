...
#
# TODO: Load up the data here into a variable called 'X'. As usual, do a .describe and a print of
# your dataset and compare it to the dataset loaded in a text file or in a spread sheet application
#
# .. your code here ..
...
#
# TODO: Create your linear regression model here and store it in a variable called 'model'. Don't
# actually train or do anything else with it yet:
#
# .. your code here ..
...
#
# TODO: Slice out your data manually (e.g. don't use train_test_split, but actually do the Indexing
# yourself. Set X_train to be year values LESS than 1986, and y_train to be corresponding WhiteMale
# age values.
#
# INFO You might also want to read the note about slicing on the bottom of this document before proceeding.
#
# .. your code here ..
...
#
# TODO: Train your model then pass it into drawLine with your training set and labels. You can title it
# "WhiteMale". drawLine will output to the console a 2014 extrapolation / approximation for what it
# believes the WhiteMale's life expectancy in the U.S. will be, given the pre-1986 data you trained it
# with. It'll also produce a 2030 and 2045 extrapolation.
#
# .. your code here ..
...
# for BlackFemales, fit your model, and then call drawLine. Lastly, print out the actual 2014
...
#
# TODO: Lastly, print out a correlation matrix for your entire dataset, and display a visualization of
# the correlation matrix, just as we described in the visualization section of the course
#
# .. your code here ..
print X.corr()
